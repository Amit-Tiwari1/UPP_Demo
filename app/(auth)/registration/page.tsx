...
export default function Registration() {
  ...
  const [candidateRegistationFormData, setcandidateRegistationFormData] =
    useState<CandidateRegistrationForm>({
      firstName: "",
      middleName: "",
      lastName: "",
      fullName: "",
  ...
  const validateForm = (): boolean => {
    ...
    if (!maritalStatus)
      formErrors.maritalStatus = "Please select a valid marital status.";
    ...
    <div className="grid grid-cols-1 border-3 border-gray-200 border rounded-t-lg">
      ...
      <div className="flex items-center bg-green-600 text-white p-4 shadow-lg rounded-t-lg">
        <Image
          ...
          className="mr-2"
        />
        <h1 className="text-3xl font-bold">Personal Details व्यक्तिगत विवरण</h1>
      </div>
